...
set EnginePath=E:\JenkinsJobs\UE_5.7_InstalledBuild\Windows
...
set COPYRIGHT_LINE=// %ProjectPureName% game copyright
set EXTRA_MODULE_NAMES="%ProjectPureName%"
set TargetTemplateFilePath=%ProjectRoot%\UEDevOps\targets\GameModule.Target.cs.template
